...
const adjs = [
  "Blue", "Red", "Big", "Hefty",
  "Green", "Tiny", "Massive", "Quick",
  "Slow", "Loud", "Quiet", "Fierce",
  "Gentle", "Clever", "Bold", "Sneaky",
  "Brave", "Calm", "Dashing", "Silly"
];

const nicknames = [
  "Penguin", "Yapper", "Nerd", "Geek",
  "Unicorn", "Tiger", "Sloth", "Phoenix",
  "Wizard", "Ninja", "Pirate", "Dragon",
  "Knight", "Panda", "Falcon", "Raven",
  "Monkey", "Fox", "Shark", "Eagle"
];
